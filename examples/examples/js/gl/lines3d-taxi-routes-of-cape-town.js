...
var readShp = new Promise(function (resolve, reject) {
  shapefile
    .open(
      ROOT_PATH + '/asset/get/s/data-1498751177695-rkzAeiGEb.shp',
      ROOT_PATH + '/asset/get/s/data-1498751184605-rJYAxjMVW.dbf'
    )
    .then((source) =>
...
myChart.showLoading();
Promise.all([
  $.getJSON(ROOT_PATH + '/asset/get/s/data-1498751206824-HkkgZsfEW.json'),
  readShp
