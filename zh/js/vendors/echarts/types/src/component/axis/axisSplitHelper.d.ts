...
export declare function rectCoordAxisBuildSplitArea(axisView: SingleAxisView | CartesianAxisView, axisGroup: graphic.Group, axisModel: (SingleAxisModel | CartesianAxisModel) & AxisBaseModel, gridModel: GridModel | SingleAxisModel): void;
