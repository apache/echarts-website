window.__EC_DOC_api_action = {
  "highlight": {
    "desc": "<p>高亮指定的数据图形。</p>\n<p>通过<code class=\"codespan\">seriesName</code>或者<code class=\"codespan\">seriesIndex</code>指定系列。如果要再指定某个数据可以再指定<code class=\"codespan\">dataIndex</code>或者<code class=\"codespan\">name</code>。</p>\n<pre><code class=\"lang-js\">dispatchAction({\n    type: &#39;highlight&#39;,\n    // 可选，系列 index，可以是一个数组指定多个系列\n    seriesIndex?: number|Array,\n    // 可选，系列名称，可以是一个数组指定多个系列\n    seriesName?: string|Array,\n    // 可选，数据的 index\n    dataIndex?: number,\n    // 可选，数据的 名称\n    name?: string\n})\n</code></pre>\n"
  },
  "downplay": {
    "desc": "<p>取消高亮指定的数据图形。</p>\n<p>通过<code class=\"codespan\">seriesName</code>或者<code class=\"codespan\">seriesIndex</code>指定系列。如果要指定某个数据可以再指定<code class=\"codespan\">dataIndex</code>或者<code class=\"codespan\">name</code>。</p>\n<pre><code class=\"lang-js\">dispatchAction({\n    type: &#39;downplay&#39;,\n    // 可选，系列 index，可以是一个数组指定多个系列\n    seriesIndex?: number|Array,\n    // 可选，系列名称，可以是一个数组指定多个系列\n    seriesName?: string|Array,\n    // 可选，数据的 index\n    dataIndex?: number,\n    // 可选，数据的 名称\n    name?: string\n})\n</code></pre>\n<!--============= legend ==========-->"
  },
  "legend": {
  ...
  "map": {
    "desc": "<p><a href=\"option.html#series-map\" target=\"_blank\">地图图表</a>相关的行为，必须引入<a href=\"option.html#series-map\" target=\"_blank\">地图图表</a>后才能使用。</p>\n"
  },
  "map.mapSelect": {
