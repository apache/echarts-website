window.__EC_DOC_option_radar = {
  ...
  "nameGap": {
    "desc": "<p>Distance between the indicator&#39;s name and axis.</p>\n",
    "uiControl": {
      "type": "number",
      "default": "15",
      "step": "1"
  ...
  "splitNumber": {
    "desc": "<p>Segments of indicator axis.</p>\n",
    "uiControl": {
      "type": "number",
      "default": "15",
      "step": "1"
  ...
  "shape": {
    "desc": "<p>Radar render type, in which <code class=\"codespan\">&#39;polygon&#39;</code> and <code class=\"codespan\">&#39;circle&#39;</code> are supported.</p>\n",
    "uiControl": {
      "type": "enum",
  ...
  "scale": {
    "desc": "<p>Whether to prevent calculating the scaling relative to zero. If it is set to be <code class=\"codespan\">true</code>, the coordinate tick would not compulsorily contain zero value, which is usually useful in scatter diagram of double numerical values axis.</p>\n",
    "uiControl": {
      "type": "boolean"
    }
  },
  ...
  "indicator.max": {
    "desc": "<p>The maximum value of indicator. It is an optional configuration, but we recommend to set it manually.</p>\n",
    "uiControl": {
      "type": "number",
      "default": "100",
      "step": "1"
  ...
  "indicator.min": {
    "desc": "<p>The minimum value of indicator. It it an optional configuration, with default value of 0.</p>\n",
    "uiControl": {
      "type": "number",
      "step": "1"
    }
  ...
  "color": {
    "desc": "<p>Specfy a color the the indicator.</p>\n"
  }
}