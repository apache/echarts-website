window.__EC_DOC_option_series_tree = {
  ...
  "center": {
    "desc": "<p>Center of current view-port. It can be an arrary containing two <code class=\"codespan\">number</code>s in pixels or <code class=\"codespan\">string</code>s in percentage relative to the container width/height.\n<code class=\"codespan\">string</code> is supported from version <code class=\"codespan\">5.3.3</code>.</p>\n<p>Example:</p>\n<pre><code class=\"lang-ts\">center: [115.97, &#39;30%&#39;]\n</code></pre>\n"
  },
  "zoom": {
  ...
  "data.collapsed": {
    "desc": "<p>Whether to collapse node at initialization.</p>\n"
  },
  "data.itemStyle": {
