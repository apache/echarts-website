...
*   `'cartesian2d'`
    ...
    Lay out based on a two-dimensional [rectangular coordinate system (also known as Cartesian coordinate system)](option.grid.md). When multiple `xAxis` or multiple `yAxis` exist within an ECharts instance, the corresponding axes should be specified using [xAxisIndex](option.series-pictorialBar.md#xAxisIndex) and [yAxisIndex](option.series-pictorialBar.md#yAxisIndex) or [xAxisId](option.series-pictorialBar.md#xAxisId) and [yAxisId](option.series-pictorialBar.md#yAxisId).
...
See also [series-pictorialBar.coordinateSystemUsage](option.series-pictorialBar.md#coordinateSystemUsage).
...
Specify how to lay out this `series-pictorialBar` based on the specified [coordinateSystem](option.series-pictorialBar.md#coordinateSystem).
...
*   `'box'`: **(Not applicable in [series-pictorialBar](option.series-pictorialBar.md))**
    ...
    *   For example, a [grid component](option.grid.md) can be laid out in a [matrix coordinate system](option.matrix.md) or a [calendar coordinate system](option.calendar.md), where its layout rectangle is calculated by the specified [series-pictorialBar.coords](option.series-pictorialBar.md#coords) in that system. See example [sparkline in matrix](https://echarts.apache.org/examples/en/editor.html?c=matrix-sparkline&edit=1&reset=1).
...
See also [series-pictorialBar.coordinateSystem](option.series-pictorialBar.md#coordinateSystem).
...
When [coordinateSystemUsage](option.series-pictorialBar.md#coordinateSystemUsage) is `'box'`, `coord` is used as the input to the coordinate system and calculate the layout rectangle or anchor point.
...
> Note: when [coordinateSystemUsage](option.series-pictorialBar.md#coordinateSystemUsage) is `'data'`, the input of coordinate system is `series.data[i]` rather than this `coord`.
...
Configurations of blur state. Available when [emphasis.focus](option.series-pictorialBar.md#emphasis.focus) is set.
...
Configurations of select state. Available when [selectedMode](option.series-pictorialBar.md#selectedMode) is set.
...
Has higher priority than [barWidth](option.series-bar.md#barWidth).
...
This attribute can be set at the [root level of a series](option.series-pictorialBar.md#symbol), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](option.series-pictorialBar.md#data.symbol) in [series-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
When percent value is used, final size of the graphic element is calculated based on its [reference bar](option.series-pictorialBar.md).

For example, there is a reference bar based on x axis (that is, it is a vertical bar), and [symbolSize](option.series-pictorialBar.md#symbolSize) is set as `['30%', '50%']`, the final size of its graphic elements is:

*   width: `<width of reference bar> * 30%`.
*   height:
    *   If [symbolRepeat](option.series-pictorialBar.md#symbolRepeat) is used: `<height of reference bar> * 50%`.
    *   If [symbolRepeat](option.series-pictorialBar.md#symbolRepeat) is not used: `<height of reference bar> * 50%`.

Analogously, the case that based on y axis can be obtained by exchanging them.

For example:

This attribute can be set at the [root level of a series](option.series-pictorialBar.md#symbolSize), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](option.series-pictorialBar.md#data.symbolSize) in [series-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
This attribute can be set at the [root level of a series](option.series-pictorialBar.md#symbolPosition), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](option.series-pictorialBar.md#data.symbolPosition) in [series-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
A absolute value can be set (like `10`), or a percent value can be set (like `'120%'`、`['55%', 23]`), which is based on its [symbolSize](option.series-pictorialBar.md#symbolSize).

For example, `[0, '-50%']` means the graphic element will be adjusted upward half of the size of itself.

For example:

This attribute can be set at the [root level of a series](option.series-pictorialBar.md#symbolOffset), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](option.series-pictorialBar.md#data.symbolOffset) in [series-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
This attribute can be set at the [root level of a series](option.series-pictorialBar.md#symbolRotate), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](option.series-pictorialBar.md#data.symbolRotate) in [series-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
*   `true`: Repeat, that is, a group of repeated graphic elements represent a data item. The repeat times is calculated according to [data](option.series-pictorialBar.md#data).
...
*   `'fixed'`: Repeat, that is a group of repeated graphic elements represent a data item. The repeat times is calcuated according to [symbolBoundingData](option.series-pictorialBar.md#symbolBoundingData), that is, the repeat times has nothing to do with [data](option.series-pictorialBar.md#data). The setting is useful when graphic elements are used as background.

For example:

This attribute can be set at the [root level of a series](option.series-pictorialBar.md#symbolRepeat), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](option.series-pictorialBar.md#data.symbolRepeat) in [series-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
When [symbolRepeat](option.series-pictorialBar.md#symbolRepeat) is used, `symbolRepeatDirection` specifies the render order of the repeated graphic elements. The setting is useful in these cases below:

*   If [symbolMargin](option.series-pictorialBar.md#symbolMargin) is set as a negative value, repeated elements will overlap with each other. `symbolRepeatDirection` can be used to specify the order of overlap.
    
*   If [animationDelay](option.series-pictorialBar.md#animationDelay) or [animationDelayUpdate](option.series-pictorialBar.md#animationDelayUpdate) is used, `symbolRepeatDirection` specifies the order of index.
...
This attribute can be set at the [root level of a series](option.series-pictorialBar.md#symbolRepeatDirection), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](option.series-pictorialBar.md#data.symbolRepeatDirection) in [series-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
Specify margin of both sides of a graphic element. ("both sides" means the two sides in the direction of its value axis). It works only when [symbolRepeat](option.series-pictorialBar.md#symbolRepeat) is used.

Absolute value can be used (like `20`), or percent value can be used (like `'-30%'`), which is based on its [symbolSize](option.series-pictorialBar.md#symbolSize).

`symbolMargin` can be positive value or negative value, which enables overlap of graphic elements when [symbolRepeat](option.series-pictorialBar.md#symbolRepeat) is used.
...
*   When [symbolRepeat](option.series-pictorialBar.md#symbolRepeat) is `true`/`'fixed'`: The given `symbolMargin` is just a reference value. The final gap of graphic elements will be calculated according to [symbolRepeat](option.series-pictorialBar.md#symbolRepeat), `symbolMargin` and [symbolBoundingData](option.series-pictorialBar.md#symbolBoundingData).
*   When [symbolRepeat](option.series-pictorialBar.md#symbolRepeat) is set as a number: `symbolMargin` does not work any more.

For example:

This attribute can be set at the [root level of a series](option.series-pictorialBar.md#symbolMargin), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](option.series-pictorialBar.md#data.symbolMargin) in [series-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
*   The same [symbolBoundingData](../option.md#series.pictorialBar.symbolBoundingData) is used in "background series" and "current value seires", which makes their graphic elements are the same size.
*   A bigger [z](../option.md#series.pictorialBar.z) is set on "current value series", which makes it is over "background series".

This attribute can be set at the [root level of a series](option.series-pictorialBar.md#symbolClip), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](option.series-pictorialBar.md#data.symbolClip) in [series-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
*   If [symbolRepeat](option.series-pictorialBar.md#symbolRepeat) is not used:
...
*   If [symbolRepeat](option.series-pictorialBar.md#symbolRepeat) is used:
    
    `symbolBoundingData` is the extreme value of the coordinate system. `symbolBoundingData` defines a bounding area, where repeated graphic elements layout according to [symbolMargin](option.series-pictorialBar.md#symbolMargin) and [symbolRepeat](option.series-pictorialBar.md#symbolRepeat) and [symbolSize](option.series-pictorialBar.md#symbolSize). Both these settings determine the gap size of the repeated graphic elements.
    

`symbolBoundingData` is usually used in these cases:

*   When [symbolCilp](option.series-pictorialBar.md#symbolClip) is used:
...
*   When [symbolRepeat](option.series-pictorialBar.md#symbolRepeat) is used:
...
This attribute can be set at the [root level of a series](option.series-pictorialBar.md#symbolBoundingData), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](option.series-pictorialBar.md#data.symbolBoundingData) in [series-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
This attribute can be set at the [root level of a series](option.series-pictorialBar.md#symbolPatternSize), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](option.series-pictorialBar.md#data.symbolPatternSize) in [series-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
The first parameter `value` is the value in [data](option.series-pictorialBar.md#data), and the second parameter `params` is the rest parameters of data item.
...
1.  Assign coordinate according to container with [x](option.series-pictorialBar.md#markPoint.data.x), [y](option.series-pictorialBar.md#markPoint.data.y) attribute, in which pixel values and percentage are supported.

2.  Assign coordinate position with [coord](option.series-pictorialBar.md#markPoint.data.coord) attribute, in which `'min'`, `'max'`, `'average'` are supported for each dimension.
    
3.  Use [type](option.series-pictorialBar.md#markPoint.data.type) attribute to mark the maximum and minimum values in the series, in which [valueIndex](option.series-pictorialBar.md#markPoint.data.valueIndex) or [valueDim](option.series-pictorialBar.md#markPoint.data.valueDim) can be used to assign the dimension.
...
Mark point name. Can be used as a template variable **data name** `{b}` in [label formatter](option.series-pictorialBar.md#markPoint.data.label.formatter).
...
Available when using [type](option.series-pictorialBar.md#markPoint.data.type) it is used to assign maximum value and minimum value in dimensions, it could be `0` (xAxis, radiusAxis), `1` (yAxis, angleAxis), and use the first value axis dimension by default.

#### markPoint.data.valueDim
- **Type**: `string`

Works only when [type](option.series-pictorialBar.md#markPoint.data.type) is assigned. It is used to state the dimension used to calculate maximum value or minimum value. It may be the direct name of a dimension, like `x`, or `angle` for line charts, or `open`, or `close` for candlestick charts.
...
Options: `'container'` or `'coordinate'`. Specify whether the positions of [x](option.series-pictorialBar.md#markPoint.data.x) and [y](option.series-pictorialBar.md#markPoint.data.y) are relative to the entire chart container (`'container'`, default) or the grid coordinate system (`'coordinate'`).
...
Symbol type at the two ends of the mark line. It can be an array for two ends, or assigned separately. See [data.symbol](option.series-pictorialBar.md#markLine.data.0.symbol) for more format information.
...
1.  Assign coordinate according to container with [x](option.series-pictorialBar.md#markLine.data.0.x), [y](option.series-pictorialBar.md#markLine.data.0.y) attribute, in which pixel values and percentage are supported.

2.  Assign coordinate position with [coord](option.series-pictorialBar.md#markLine.data.0.coord) attribute, in which `'min'`, `'max'`, `'average'` are supported for each dimension.
    
3.  Use [type](option.series-pictorialBar.md#markLine.data.0.type) attribute to mark the maximum and minimum values in the series, in which [valueIndex](option.series-pictorialBar.md#markLine.data.0.valueIndex) or [valueDim](option.series-pictorialBar.md#markLine.data.0.valueDim) can be used to assign the dimension.
...
Works only when [type](option.series-pictorialBar.md#markLine.data.type) is assigned. It is used to state the dimension used to calculate maximum value or minimum value. It may be `0` (for xAxis, or radiusAxis), or `1` (for yAxis, or angleAxis). Dimension of the first numeric axis is used by default.

##### markLine.data.0.valueDim
- **Type**: `string`

Works only when [type](option.series-pictorialBar.md#markLine.data.type) is assigned. It is used to state the dimension used to calculate maximum value or minimum value. It may be the direct name of a dimension, like `x`, or `angle` for line charts, or `open`, or `close` for candlestick charts.
...
Name of the marker. Can be used as a template variable **data name** `{b}` in [label formatter](option.series-pictorialBar.md#markLine.data.label.formatter).
...
1.  Specify the coordinate in screen coordinate system using [x](option.series-pictorialBar.md#markArea.data.0.x), [y](option.series-pictorialBar.md#markArea.data.0.y), where the unit is pixel (e.g., the value is `5`), or percent (e.g., the value is `'35%'`).

2.  Specify the coordinate in data coordinate system (i.e., cartesian) using [coord](option.series-pictorialBar.md#markArea.data.0.coord), which can be also set as `'min'`, `'max'`, `'average'` (e.g, `coord: [23, 'min']`, or `coord: ['average', 'max']`).
    
3.  Locate the point on the min value or max value of `series.data` using [type](option.series-pictorialBar.md#markArea.data.0.type), where [valueIndex](option.series-pictorialBar.md#markArea.data.0.valueIndex) or [valueDim](option.series-pictorialBar.md#markPoint.data.0.valueDim) can be used to specify the dimension on which the min, max or average are calculated.
...
Specify the dimension on which min, max, average are calculated, available when [type](option.series-pictorialBar.md#markArea.data.type) used. The value can be `0` (means xAxis, radiusAxis) or `1` (means yAxis, angleAxis), using the dimension of the first axis by default.

##### markArea.data.0.valueDim
- **Type**: `string`

Specify the dimension on which min, max, average are calculated, available when [type](option.series-pictorialBar.md#markArea.data.type) used. The value can be the name of the dimension (for example, the value can be `x`, `angle` in line chart, and `open`, `close` in candlestick).
...
Name of the marker, which will display as a label. Can be used as a template variable **data name** `{b}` in [label formatter](option.series-pictorialBar.md#markArea.data.label.formatter).
