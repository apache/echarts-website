...
Specifies another coordinate system component on which this `series-funnel` is laid out.
...
*   `'calendar'`
    ...
    Lay out based on a [calendar coordinate system](option.calendar.md). When multiple calendar coordinate systems exist within an ECharts instance, the corresponding system should be specified using [calendarIndex](option.series-funnel.md#calendarIndex) or [calendarId](option.series-funnel.md#calendarId).
    

*   `'matrix'`
    
    Lay out based on a [matrix coordinate system](option.matrix.md). When multiple matrix coordinate systems exist within an ECharts instance, the corresponding system should be specified using [matrixIndex](option.series-funnel.md#matrixIndex) or [matrixId](option.series-funnel.md#matrixId).
...
See also [series-funnel.coordinateSystemUsage](option.series-funnel.md#coordinateSystemUsage).
...
Specify how to lay out this `series-funnel` based on the specified [coordinateSystem](option.series-funnel.md#coordinateSystem).
...
*   `'box'`: **(Not applicable in [series-funnel](option.series-funnel.md))**
    ...
    *   For example, a [grid component](option.grid.md) can be laid out in a [matrix coordinate system](option.matrix.md) or a [calendar coordinate system](option.calendar.md), where its layout rectangle is calculated by the specified [series-funnel.coords](option.series-funnel.md#coords) in that system. See example [sparkline in matrix](https://echarts.apache.org/examples/en/editor.html?c=matrix-sparkline&edit=1&reset=1).
...
See also [series-funnel.coordinateSystem](option.series-funnel.md#coordinateSystem).
...
When [coordinateSystemUsage](option.series-funnel.md#coordinateSystemUsage) is `'box'`, `coord` is used as the input to the coordinate system and calculate the layout rectangle or anchor point.
...
> Note: when [coordinateSystemUsage](option.series-funnel.md#coordinateSystemUsage) is `'data'`, the input of coordinate system is `series.data[i]` rather than this `coord`.
...
The mapped width from minimum data value [min](option.series-funnel.md#min).

It can be absolute pixel and also the percentage of [layout width](option.series-funnel.md#width). If you don't want the graph of minimum value to be a triangle, you can set up this property larger than 0.

## maxSize
- **Type**: `number|string`
- **Default**: `'100%'`

The mapped width from maximum data value [max](option.series-funnel.md#max).

It can be absolute pixel and also the percentage of [layout width](option.series-funnel.md#width).
...
Text label of funnel chart, to explain some data information about graphic item like value, name and so on. `label` is placed under `itemStyle` in ECharts 2.x. In ECharts 3, to make the configuration structure flatter, `label`is taken to be at the same level with `itemStyle`, and has `emphasis` as `itemStyle` does.
...
*   `'left'`Left side of funnel chart. Available when [orient](option.series-funnel.md#orient) is `'vertical'`.
*   `'right'` Right side of funnel chart. Available when [orient](option.series-funnel.md#orient) is `'horizontal'`.
*   `'top'` Top side of funnel chart. Available when [orient](option.series-funnel.md#orient) is `'vertical'`.
*   `'bottom'` Bottom side of funnel chart. Available when [orient](option.series-funnel.md#orient) is `'vertical'`.
...
[labelLine](option.series-funnel.md#labelLine) can be used to guide to the corresponding trapezoid when label is not inside.
...
The visual guide line style of label. When [label position](option.series-funnel.md#label.position) is set as `'left'`or`'right'`, the visual guide line will show.
...
Configurations of blur state. Available when [emphasis.focus](option.series-funnel.md#emphasis.focus) is set.
...
Configurations of select state. Available when [selectedMode](option.series-funnel.md#selectedMode) is set.
...
The first parameter `value` is the value in [data](option.series-funnel.md#data), and the second parameter `params` is the rest parameters of data item.
...
1.  Assign coordinate according to container with [x](option.series-funnel.md#markPoint.data.x), [y](option.series-funnel.md#markPoint.data.y) attribute, in which pixel values and percentage are supported.
...
Mark point name. Can be used as a template variable **data name** `{b}` in [label formatter](option.series-funnel.md#markPoint.data.label.formatter).
...
Options: `'container'` or `'coordinate'`. Specify whether the positions of [x](option.series-funnel.md#markPoint.data.x) and [y](option.series-funnel.md#markPoint.data.y) are relative to the entire chart container (`'container'`, default) or the grid coordinate system (`'coordinate'`).
...
Symbol type at the two ends of the mark line. It can be an array for two ends, or assigned separately. See [data.symbol](option.series-funnel.md#markLine.data.0.symbol) for more format information.
...
1.  Assign coordinate according to container with [x](option.series-funnel.md#markLine.data.0.x), [y](option.series-funnel.md#markLine.data.0.y) attribute, in which pixel values and percentage are supported.
...
Name of the marker. Can be used as a template variable **data name** `{b}` in [label formatter](option.series-funnel.md#markLine.data.label.formatter).
...
1.  Specify the coordinate in screen coordinate system using [x](option.series-funnel.md#markArea.data.0.x), [y](option.series-funnel.md#markArea.data.0.y), where the unit is pixel (e.g., the value is `5`), or percent (e.g., the value is `'35%'`).
...
Name of the marker, which will display as a label. Can be used as a template variable **data name** `{b}` in [label formatter](option.series-funnel.md#markArea.data.label.formatter).
