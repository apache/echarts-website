...
Distance between themeRiver series and the left side of the container.
...
Distance between themeRiver series and the top side of the container.
...
Distance between themeRiver series and the right side of the container.
...
Distance between themeRiver series and the bottom side of the container.
...
Specifies another coordinate system component on which this `series-themeRiver` is laid out.

Options:

*   `'singleAxis'`
    
    Lay out based on a [singleAxis coordinate system](option.singleAxis.md). When multiple singleAxis coordinate systems exist within an ECharts instance, the corresponding system should be specified using [singleAxisIndex](option.series-themeRiver.md#polarIndex) or [singleAxisId](option.series-themeRiver.md#polarId).
...
See also [series-themeRiver.coordinateSystemUsage](option.series-themeRiver.md#coordinateSystemUsage).
...
Specify how to lay out this `series-themeRiver` based on the specified [coordinateSystem](option.series-themeRiver.md#coordinateSystem).
...
*   `'box'`: **(Not applicable in [series-themeRiver](option.series-themeRiver.md))**
    ...
    *   For example, a [grid component](option.grid.md) can be laid out in a [matrix coordinate system](option.matrix.md) or a [calendar coordinate system](option.calendar.md), where its layout rectangle is calculated by the specified [series-themeRiver.coords](option.series-themeRiver.md#coords) in that system. See example [sparkline in matrix](https://echarts.apache.org/examples/en/editor.html?c=matrix-sparkline&edit=1&reset=1).
...
See also [series-themeRiver.coordinateSystem](option.series-themeRiver.md#coordinateSystem).
...
When [coordinateSystemUsage](option.series-themeRiver.md#coordinateSystemUsage) is `'box'`, `coord` is used as the input to the coordinate system and calculate the layout rectangle or anchor point.
...
> Note: when [coordinateSystemUsage](option.series-themeRiver.md#coordinateSystemUsage) is `'data'`, the input of coordinate system is `series.data[i]` rather than this `coord`.
