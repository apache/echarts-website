...
*   `'geo'`
    ...
    Lay out based on a [geographic coordinate system](option.geo.md). When multiple geographic coordinate systems exist within an ECharts instance, the corresponding system should be specified using [geoIndex](option.series-pie.md#geoIndex) or [geoId](option.series-pie.md#geoId).
    
    See example [pie in geo](https://echarts.apache.org/examples/en/editor.html?c=map-iceland-pie&edit=1&reset=1).
    

*   `'calendar'`
    
    Lay out based on a [calendar coordinate system](option.calendar.md). When multiple calendar coordinate systems exist within an ECharts instance, the corresponding system should be specified using [calendarIndex](option.series-pie.md#calendarIndex) or [calendarId](option.series-pie.md#calendarId).
    

*   `'matrix'`
    
    Lay out based on a [matrix coordinate system](option.matrix.md). When multiple matrix coordinate systems exist within an ECharts instance, the corresponding system should be specified using [matrixIndex](option.series-pie.md#matrixIndex) or [matrixId](option.series-pie.md#matrixId).
...
See also [series-pie.coordinateSystemUsage](option.series-pie.md#coordinateSystemUsage).
...
Specify how to lay out this `series-pie` based on the specified [coordinateSystem](option.series-pie.md#coordinateSystem).
...
*   `'box'`: **(Not applicable in [series-pie](option.series-pie.md))**
    ...
    *   For example, a [grid component](option.grid.md) can be laid out in a [matrix coordinate system](option.matrix.md) or a [calendar coordinate system](option.calendar.md), where its layout rectangle is calculated by the specified [series-pie.coords](option.series-pie.md#coords) in that system. See example [sparkline in matrix](https://echarts.apache.org/examples/en/editor.html?c=matrix-sparkline&edit=1&reset=1).
...
See also [series-pie.coordinateSystem](option.series-pie.md#coordinateSystem).
...
When [coordinateSystemUsage](option.series-pie.md#coordinateSystemUsage) is `'box'`, `coord` is used as the input to the coordinate system and calculate the layout rectangle or anchor point.
...
[series-pie.center](option.series-pie.md#center) and [series-pie.coord](option.series-pie.md#coord) can be used interchangably in this case.

[example: pie in geo](https://echarts.apache.org/examples/en/editor.html?c=map-iceland-pie&edit=1&reset=1)

> Note: when [coordinateSystemUsage](option.series-pie.md#coordinateSystemUsage) is `'data'`, the input of coordinate system is `series.data[i]` rather than this `coord`.
...
When the value is `'auto'`, the end angle is calculated automatically based on [startAngle](option.series-pie.md#startAngle) to ensure it is a complete circle.
...
Width of pie series. Adaptive by default.
...
Height of pie series. Adaptive by default.
...
### emptyCircleStyle.borderColor
- **Type**: `Color`
- **Default**: `'#000'`

border color, whose format is similar to that of `color`.

### emptyCircleStyle.borderWidth
- **Type**: `number`
- **Default**: `0`
...
### emptyCircleStyle.borderDashOffset
- **Type**: `number`
- **Default**: `0`
...
### emptyCircleStyle.borderMiterLimit
- **Type**: `number`
- **Default**: `10`
...
### emptyCircleStyle.shadowColor
- **Type**: `Color`

Shadow color. Support same format as `color`.

### emptyCircleStyle.shadowOffsetX
- **Type**: `number`
- **Default**: `0`

Offset distance on the horizontal direction of shadow.

### emptyCircleStyle.shadowOffsetY
- **Type**: `number`
- **Default**: `0`

Offset distance on the vertical direction of shadow.

### emptyCircleStyle.opacity
- **Type**: `number`
...
*   `'outside'`
    ...
    Outside of sectors of pie chart, which relates to corresponding sector through [visual guide line](option.series-pie.md#labelLine).
...
*   `'center'`
    ...
    In the center of pie chart. See [pie-doughnut example](https://echarts.apache.org/examples/en/editor.html?c=pie-doughnut)
...
*   `'none'` (default): label lines have fixed length as [labelLine.length](option.series-pie.md#labelLine.length) and [labelLine.length2](option.series-pie.md#labelLine.length2).
*   `'labelLine'`: aligning to the end of label lines and the length of the shortest horizontal label lines is configured by [labelLine.length2](option.series-pie.md#labelLine.length2).
*   `'edge'`: aligning to text and the distance between the edges of text and the viewport is configured by [label.edgeDistance](option.series-pie.md#label.edgeDistance).

### label.edgeDistance
- **Type**: `string|number`
- **Default**: `'25%'`

The horizontal distance between text edges and viewport when [label.position](option.series-pie.md#label.position) is `'outer'` and [label.alignTo](option.series-pie.md#label.alignTo) is `'edge'`.

In most cases, you need a small `edgeDistance` value like `10` for mobile devices to make sure more text can be shown instead of being `...`. But on larger resolutions, a percentage value should be applied so that the label lines won't be too long. If your chart is used in varied resolutions, it is advised to set [responsive design](../tutorial.md#Responsive%20Mobile-End) for different resolutions.

### label.bleedMargin
- **Type**: `number`
- **Default**: `10`

The horizontal distance between text and viewport when [label.position](option.series-pie.md#label.position) is `'outer'` and [label.alignTo](option.series-pie.md#label.alignTo) is `'none'` or `'labelLine'`. Longer text will be truncated into `'...'`.
...
The style of visual guide line. Will show when [label position](option.series-pie.md#label.position) is set as `'outside'`.
...
Size of scale. Available when [emphasis.scale](option.series-pie.md#emphasis.scale) is set as `true`.
...
Configurations of blur state. Available when [emphasis.focus](option.series-pie.md#emphasis.focus) is set.
...
Configurations of select state. Available when [selectedMode](option.series-pie.md#selectedMode) is set.
...
The first parameter `value` is the value in [data](option.series-pie.md#data), and the second parameter `params` is the rest parameters of data item.
...
1.  Assign coordinate according to container with [x](option.series-pie.md#markPoint.data.x), [y](option.series-pie.md#markPoint.data.y) attribute, in which pixel values and percentage are supported.
...
Mark point name. Can be used as a template variable **data name** `{b}` in [label formatter](option.series-pie.md#markPoint.data.label.formatter).
...
Options: `'container'` or `'coordinate'`. Specify whether the positions of [x](option.series-pie.md#markPoint.data.x) and [y](option.series-pie.md#markPoint.data.y) are relative to the entire chart container (`'container'`, default) or the grid coordinate system (`'coordinate'`).
...
Symbol type at the two ends of the mark line. It can be an array for two ends, or assigned separately. See [data.symbol](option.series-pie.md#markLine.data.0.symbol) for more format information.
...
1.  Assign coordinate according to container with [x](option.series-pie.md#markLine.data.0.x), [y](option.series-pie.md#markLine.data.0.y) attribute, in which pixel values and percentage are supported.
...
Name of the marker. Can be used as a template variable **data name** `{b}` in [label formatter](option.series-pie.md#markLine.data.label.formatter).
...
1.  Specify the coordinate in screen coordinate system using [x](option.series-pie.md#markArea.data.0.x), [y](option.series-pie.md#markArea.data.0.y), where the unit is pixel (e.g., the value is `5`), or percent (e.g., the value is `'35%'`).
...
Name of the marker, which will display as a label. Can be used as a template variable **data name** `{b}` in [label formatter](option.series-pie.md#markArea.data.label.formatter).
