...
Specify which [xAxis](option.xAxis.md) is/are controlled by the `dataZoom-inside` when [catesian coordinate system](option.grid.md) is used.

By default the first `xAxis` that parallel to `dataZoom` are controlled when [dataZoom-inside.orient](option.dataZoom-inside.md#orient) is set as `'horizontal'`. But it is recommended to specify it explicitly but not use default value.
...
Specify which [yAxis](option.yAxis.md) is/are controlled by the `dataZoom-inside` when [catesian coordinate system](option.grid.md) is used.

By default the first `yAxis` that parallel to `dataZoom` are controlled when [dataZoom-inside.orient](option.dataZoom-inside.md#orient) is set as `'vertical'`. But it is recommended to specify it explicitly but not use default value.
...
Specify which [radiusAxis](option.radiusAxis.md) is/are controlled by the `dataZoom-inside` when [polar coordinate system](option.polar.md) is used.
...
Specify which [angleAxis](option.angleAxis.md) is/are controlled by the `dataZoom-inside` when [polar coordinate system](option.polar.md) is used.
...
[dataZoom-inside.start](option.dataZoom-inside.md#start) and [dataZoom-inside.end](option.dataZoom-inside.md#end) define the window of the data in **percent** form.

More info about the relationship between `dataZoom-inside.start` and axis extent can be checked in [dataZoom-inside.rangeMode](option.dataZoom-inside.md#rangeMode).
...
More info about the relationship between `dataZoom-inside.end` and axis extent can be checked in [dataZoom-inside.rangeMode](option.dataZoom-inside.md#rangeMode).

## startValue
- **Type**: `number|string|Date`

The start absolute value of the window, not works when [dataZoom-inside.start](option.dataZoom-inside.md#start) is set.

[dataZoom-inside.startValue](option.dataZoom-inside.md#startValue) and [dataZoom-inside.endValue](option.dataZoom-inside.md#endValue) define the window of the data window in **absolute value** form.
...
More info about the relationship between `dataZoom-inside.startValue` and axis extent can be checked in [dataZoom-inside.rangeMode](option.dataZoom-inside.md#rangeMode).

## endValue
- **Type**: `number|string|Date`

The end absolute value of the window, doesn't work when [dataZoom-inside.end](option.dataZoom-inside.md#end) is set.

[dataZoom-inside.startValue](option.dataZoom-inside.md#startValue) and [dataZoom-inside.endValue](option.dataZoom-inside.md#endValue) define the window of the data window in **absolute value** form.

Notice, if an axis is set to be `category`, `startValue` could be set as `index` of the array of `axis.data` or as the array value itself. In the latter case, it will internally and automatically translate to the index of array.

More info about the relationship between `dataZoom-inside.endValue` and axis extent can be checked in [dataZoom-inside.rangeMode](option.dataZoom-inside.md#rangeMode).
...
If [dataZoom-inside.minValueSpan](option.dataZoom-inside.md#minValueSpan) is set, `minSpan` does not work any more.
...
If [dataZoom-inside.maxValueSpan](option.dataZoom-inside.md#maxValueSpan) is set, `maxSpan` does not work any more.
...
The mouse style when mouse hovers over the grabbable area, the same as `cursor` property in `CSS`.
...
The mouse style when grabbing, the same as `cursor` property in `CSS`.
