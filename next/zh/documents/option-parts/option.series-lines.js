window.__EC_DOC_option_series_lines = {
  ...
  "polyline": {
    "desc": "<p>是否是多段线。</p>\n<p>默认为 <code class=\"codespan\">false</code>，只能用于绘制只有两个端点的线段，线段可以通过 <a href=\"#series-lines.lineStyle.curveness\">lineStyle.curveness</a> 配置为曲线。</p>\n<p>如果该配置项为 <code class=\"codespan\">true</code>，则可以在 <a href=\"#series-lines.data.coords\">data.coords</a> 中设置多于 2 个的顶点用来绘制多段线，在绘制路线轨迹的时候比较有用，见示例 <a href=\"https://echarts.apache.org/next/examples/zh/editor.html?c=lines-bmap-bus\" target=\"_blank\">北京公交路线</a>，设置为多段线后 <a href=\"#series-lines.lineStyle.curveness\">lineStyle.curveness</a> 无效。</p>\n"
  },
  "effect": {
    "desc": "<p>线特效的配置，见示例 <a href=\"https://echarts.apache.org/next/examples/zh/editor.html?c=geo-lines\" target=\"_blank\">模拟迁徙</a> 和 <a href=\"https://echarts.apache.org/next/examples/zh/editor.html?c=lines-bmap-effect\" target=\"_blank\">北京公交路线</a></p>\n<p><strong>注意：</strong> 所有带有尾迹特效的图表需要单独放在一个层，也就是需要单独设置 <a href=\"#series-lines.zlevel\">zlevel</a>，同时建议关闭该层的动画（<a href=\"#series-lines.animation\">animation</a>: false）。不然位于同个层的其它系列的图形，和动画的<a href=\"#series-lines.label\">标签</a>也会产生不必要的残影。</p>\n"
  },
  "effect.show": {
    "desc": "<p>是否显示特效。</p>\n"
  },
