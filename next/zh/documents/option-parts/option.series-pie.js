window.__EC_DOC_option_series_pie = {
  ...
  "avoidLabelOverlap": {
    "desc": "\n\n<p>是否启用防止标签重叠策略，默认开启，在标签拥挤重叠的情况下会挪动各个标签的位置，防止标签间的重叠。</p>\n<p>如果不需要开启该策略，例如<a href=\"https://echarts.apache.org/next/examples/zh/editor.html?c=pie-doughnut\" target=\"_blank\">圆环图</a>这个例子中需要强制所有标签放在中心位置，可以将该值设为 <code class=\"codespan\">false</code>。</p>\n",
    "uiControl": {
      "type": "boolean",
      "default": "true"
    }
  ...
  "label.distanceToLabelLine": {
    "desc": "\n\n<p>文字与 label line 之间的距离。</p>\n<iframe  data-src=\"https://echarts.apache.org/next/examples/zh/view.html?c=doc-example/pie-label-distanceToLabelLine&edit=1&reset=1\" width=\"800\" height=\"250\"></iframe>\n\n",
    "uiControl": {
      "type": "number",
      "default": "5",
      "min": "0",
