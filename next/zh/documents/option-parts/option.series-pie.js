window.__EC_DOC_option_series_pie = {
  ...
  "avoidLabelOverlap": {
    "desc": "\n\n<p>是否启用防止标签重叠策略，默认开启，在标签拥挤重叠的情况下会挪动各个标签的位置，防止标签间的重叠。</p>\n<p>如果不需要开启该策略，例如<a href=\"https://echarts.apache.org/next/examples/editor.html?c=pie-doughnut\" target=\"_blank\">圆环图</a>这个例子中需要强制所有标签放在中心位置，可以将该值设为 <code class=\"codespan\">false</code>。</p>\n",
    "uiControl": {
      "type": "boolean",
      "default": "true"
    }
